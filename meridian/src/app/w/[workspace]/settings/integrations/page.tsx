      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <Card className="p-5">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Public origin {data?.publicUrl}. Drop the embed on www.debtmarket.net. Every submit creates a contact, company, and scored lead. Open and click pixels use this origin too.
          </p>
